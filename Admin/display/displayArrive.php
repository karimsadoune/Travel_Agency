...
<tr>
    ...
    <?php } ?>
    <td>
            <a href="editArrive.php?editId=<?php echo $row[0] ?>" style="color:green">
              edit</a>
            <a href="displayArrive.php?deleteId=<?php echo $row[0] ?>" style="color:red" onclick="confirm('Are you sure want to delete this record')">
              delete
            </a>
        </td>
</tr>
...
<?php 
include '../create/createArrive.php'; ?>
</div>
