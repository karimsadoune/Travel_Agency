...
<tr>
    ...
    <?php } ?>
    <td>
            <a href="editDepart.php?editId=<?php echo $row[0] ?>" style="color:green">
              edit</a>
            <a href="displayDepart.php?deleteId=<?php echo $row[0] ?>" style="color:red" onclick="confirm('Are you sure want to delete this record')">
              delete
            </a>
        </td>
</tr>
...
<?php 
include '../create/createDepart.php'; ?>
</div>
