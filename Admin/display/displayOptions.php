...
<tr>
    ...
    <?php } ?>
    <td>
            <a href="editOptions.php?editId=<?php echo $row[0] ?>" style="color:green">
              edit
           </a>
            <a href="displayOptions.php?deleteId=<?php echo $row[0] ?>" style="color:red" onclick="confirm('Are you sure want to delete this record')">
              delete
            </a>
          </td>
</tr>
...
<?php 
include '../create/createOption.php'; ?>
</div>
